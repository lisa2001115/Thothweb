    ...
    <div>
      ...
      >
        <input
          ...
          value={value}
          onChange={e => {
            // Strip anything from @ onward so suffix stays clean
...
export function SMELoginScreen({ onSuccess, onBack }: SMELoginScreenProps) {
    ...
    <div className="h-full w-full bg-gray-50 flex flex-col items-center justify-center">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="px-8 pt-6 pb-4 text-center">
          ...
          >
            <span className="text-white text-2xl leading-none select-none" style={{ fontFamily: 'sans-serif' }}>T</span>
          </div>
          <h1 className="text-2xl text-gray-900 mb-1">SME Portal</h1>
          <p className="text-sm text-gray-400">Sign in with your T-Mobile credentials</p>
        </div>
